...
public partial class CourtSyncContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.BookingId).HasName("PK__Booking__73951ACDDF6C2241");
            ...
            entity.HasOne(d => d.Owner).WithMany(p => p.BookingOwners)
                ...
                .HasConstraintName("FK__Booking__OwnerId__4F7CD00D");
            ...
            entity.HasOne(d => d.SubCourt).WithMany(p => p.Bookings)
                ...
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__Booking__SubCour__5070F446");

            entity.HasOne(d => d.TimeSlot).WithMany(p => p.Bookings)
                .HasForeignKey(d => d.TimeSlotId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__Booking__TimeSlo__5165187F");
        ...
        {
            entity.HasKey(e => e.CheckInId).HasName("PK__CheckIn__E64976A4BED357FB");
            ...
            entity.HasOne(d => d.Booking).WithMany(p => p.CheckIns)
                ...
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__CheckIn__Booking__5629CD9C");

            entity.HasOne(d => d.SubCourt).WithMany(p => p.CheckIns)
                .HasForeignKey(d => d.SubCourtId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__CheckIn__SubCour__5535A963");
        ...
        {
            entity.HasKey(e => e.CourtId).HasName("PK__Court__C3A67CFA62E25944");
            ...
            entity.HasOne(d => d.Owner).WithMany(p => p.Courts)
                .HasForeignKey(d => d.OwnerId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__Court__OwnerID__3E52440B");
        });

        modelBuilder.Entity<Evaluate>(entity =>
        {
            entity.HasKey(e => e.EvaluateId).HasName("PK__Evaluate__2092E4DACE5F040C");
            ...
            entity.HasOne(d => d.Court).WithMany(p => p.Evaluates)
                ...
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__Evaluate__CourtI__5AEE82B9");

            entity.HasOne(d => d.User).WithMany(p => p.Evaluates)
                .HasForeignKey(d => d.UserId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__Evaluate__UserID__59FA5E80");
        });

        modelBuilder.Entity<Payment>(entity =>
        {
            entity.HasKey(e => e.PaymentId).HasName("PK__Payment__9B556A583E8D0431");
        ...
        {
            entity.HasKey(e => e.PromotionCode).HasName("PK__Promotio__A617E4B7561569E3");
            ...
            entity.HasOne(d => d.Court).WithMany(p => p.Promotions)
                .HasForeignKey(d => d.CourtId)
                .HasConstraintName("FK__Promotion__Court__47DBAE45");
        });

        modelBuilder.Entity<SubCourt>(entity =>
        {
            entity.HasKey(e => e.SubCourtId).HasName("PK__SubCourt__D8ADDD0CC159C474");
            ...
            entity.HasOne(d => d.Court).WithMany(p => p.SubCourts)
                .HasForeignKey(d => d.CourtId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__SubCourt__CourtI__4316F928");

            entity.HasOne(d => d.TimeSlot).WithMany(p => p.SubCourts)
                .HasForeignKey(d => d.TimeSlotId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__SubCourt__TimeSl__440B1D61");
        });

        modelBuilder.Entity<TimeSlot>(entity =>
        {
            entity.HasKey(e => e.TimeSlotId).HasName("PK__TimeSlot__41CC1F52CDC99719");
        ...
        {
            entity.HasKey(e => e.UserId).HasName("PK__User__1788CCAC4514E175");

            entity.ToTable("User");

            entity.HasIndex(e => e.Email, "UQ__User__A9D105349A0F56DB").IsUnique();

            entity.HasIndex(e => e.UserName, "UQ__User__C9F2845695A44D09").IsUnique();
