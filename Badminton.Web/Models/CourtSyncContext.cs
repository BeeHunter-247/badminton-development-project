...
public partial class CourtSyncContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.BookingId).HasName("PK__Booking__73951ACDE29595B2");
        ...
        {
            entity.HasKey(e => e.CheckInId).HasName("PK__CheckIn__E64976A45EB13AF2");
        ...
        {
            entity.HasKey(e => e.CourtId).HasName("PK__Court__C3A67CFA49FE1C71");
        ...
        {
            entity.HasKey(e => e.EvaluateId).HasName("PK__Evaluate__2092E4DA002FC906");
        ...
        {
            entity.HasKey(e => e.PaymentId).HasName("PK__Payment__9B556A5879429C0F");
        ...
        {
            entity.HasKey(e => e.PromotionCode).HasName("PK__Promotio__A617E4B7114387A3");
        ...
        {
            entity.HasKey(e => e.SubCourtId).HasName("PK__SubCourt__D8ADDD0C8D2EECAA");
        ...
        {
            entity.HasKey(e => e.TimeSlotId).HasName("PK__TimeSlot__41CC1F526D40AC8A");
        ...
        {
            entity.HasKey(e => e.UserId).HasName("PK__User__1788CCAC2A18BC00");

            entity.ToTable("User");

            entity.HasIndex(e => e.Email, "UQ__User__A9D10534527AEE34").IsUnique();

            entity.HasIndex(e => e.UserName, "UQ__User__C9F28456723274C0").IsUnique();
